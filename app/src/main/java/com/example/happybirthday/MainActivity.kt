        ...
        setContent {
            HappyBirthdayTheme {
                ...
                Surface(
                    ...
                    BirthdayGreetingWithImage(message = stringResource(R.string.happy_birthday_text), from = "From Anant")
                }
            }
        }
    }
...
val image= painterResource(id = R.drawable.birthday_7127890_1280)
Box{
    Image(
        painter =image,
